...
- **2024-12-01**: Battery SI Unit Standardization (Final)
  ...
  - TPMS Dashboard: All battery readings show in W (3-5 W dummy range)
  - Data view and graph axes: Battery shown in W (SI unit)
  - Updated status thresholds for battery in W (critical <2.5W, warning <3W)
